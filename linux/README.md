...
2. [อุปกรณ์ที่รองรับ](#อุปกรณ์ที่รองรับ)
3. [สถาปัตยกรรมและหลักการทำงาน](#สถาปัตยกรรมและหลักการทำงาน)
4. [โครงสร้างไฟล์](#โครงสร้างไฟล์)
5. [การทำงานของสคริปต์ install.sh](#การทำงานของสคริปต์-installsh)
6. [ขั้นตอนการติดตั้งและใช้งาน](#ขั้นตอนการติดตั้งและใช้งาน)
...
### 1. การติดตั้ง
คัดลอกไดเรกทอรี `linux/` ไปยังเครื่องเป้าหมาย และรันสคริปต์ด้วยสิทธิ์ Root:
```bash
cd /path/to/linux
...
หลังการติดตั้งประมาณ 2–5 วินาที ตรวจสอบการอ่านค่าผ่านคำสั่ง:
```bash
upsc enerex-ups
```
