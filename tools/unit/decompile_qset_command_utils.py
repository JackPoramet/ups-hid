#!/usr/bin/env python3
"""
tools/unit/decompile_qset_command_utils.py
Decompiles QSetCommandUtils and WorkMode using javap -p -c
"""
import subprocess
import sys
...
for cls in ["com.etn.wp.comms.spec.qprotocol.util.QSetCommandUtils", "com.etn.wp.common.core.constant.ups.WorkMode"]:
    print(f"==============================================================================")
    print(f" 📄 Class: {cls}")
    print(f"==============================================================================")
