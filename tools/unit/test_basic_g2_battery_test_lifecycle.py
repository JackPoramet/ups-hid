...
print("===========================================================================")
print(" [INNOVA BASIC G2] (3kVA Line-Interactive) BATTERY TEST LIFECYCLE")
print("===========================================================================")

# 1. Connect via UPSClient
print("\n[Step 1] Connecting to Innova Basic G2 via UPSClient...")
try:
    # Try explicit model first, fallback to auto_detect
    try:
        client = UPSClient(model="enerex_innova_basic_g2")
        client.connect()
    except Exception:
...
client.disconnect()
print("\n===========================================================================")
print(" INNOVA BASIC G2 BATTERY TEST LIFECYCLE VERIFICATION COMPLETED SUCCESSFULLY!")
print("===========================================================================")
