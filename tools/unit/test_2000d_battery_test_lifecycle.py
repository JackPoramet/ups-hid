...
print("===========================================================================")
print(" [OFFLINE UPS 2000D] (2000VA Offline/Line-Int) BATTERY TEST LIFECYCLE")
print("===========================================================================")

# 1. Connect via UPSClient
print("\n[Step 1] Connecting to Offline UPS 2000D via UPSClient...")
try:
    try:
...
print(f"  * Battery Runtime     : {vars_init.get('battery.runtime')} s")
...
# 7. Test Deep Test & Abort Command
print("\n[Step 7] Testing Deep Test & Abort Command via client.test_battery_stop()...")
deep_success, deep_msg = client.test_battery_deep()
print(f"  Deep Test Result: success={deep_success}, msg='{deep_msg}'")
time.sleep(1)
vars_deep = client.get_vars()
print(f"  * Status during deep test: Status={vars_deep.get('ups.status')}, Test={vars_deep.get('battery.test.status')}")
...
client.disconnect()
print("\n===========================================================================")
print(" OFFLINE UPS 2000D BATTERY TEST LIFECYCLE VERIFICATION COMPLETED SUCCESSFULLY!")
print("===========================================================================")
